// =====================================================================
// queryClassifier.js — CLASSIFY WITH RESOLVED ENTITY CONTEXT
// =====================================================================
//
...
No markdown, no backticks.`;
    // 🚨 CRITICAL SAFETY NET:
    // We pass 'unresolved' entities to catch subjective queries (e.g., "cyberpunk vibe").
    // If a concept isn't strictly in the Graph, seeing it in the "unresolved" list 
    // tells the LLM to route this to 'similarity' (Pinecone) instead of failing in Neo4j.
